...
public class LeshonSkullModel<T extends Entity> extends EntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData core = coreBody.addChild("core", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -9.5F, -2.5F));
        ...
        ModelPartData chestBone = chest.addChild("chestBone", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 2.5F));
        ...
        .uv(0, 26).cuboid(-2.0F, -13.0F, -3.0F, 4.0F, 6.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ModelPartData cube_r1 = head.addChild("cube_r1", ModelPartBuilder.create().uv(21, 0).cuboid(-0.5F, -34.5F, 6.5F, 4.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-1.5F, 18.0F, -3.0F, 0.1745F, 0.0F, 0.0F));
        ...
        .uv(10, 27).cuboid(-0.5F, -13.0F, 21.5F, 4.0F, 6.0F, 1.0F, new Dilation(-0.01F)), ModelTransform.of(-1.5F, 21.0F, 0.0F, 1.309F, 0.0F, 0.0F));
        ...
        ModelPartData Box_r1 = lAntler02.addChild("Box_r1", ModelPartBuilder.create().uv(0, 33).cuboid(-0.6F, -2.9F, -1.0F, 1.0F, 4.0F, 1.0F, new Dilation(0.2F)), ModelTransform.of(0.1F, -0.6F, 0.5F, -0.0873F, 0.0F, -0.0436F));
        ...
        ModelPartData lAntler03c = lAntler03b.addChild("lAntler03c", ModelPartBuilder.create().uv(12, 34).cuboid(-0.5F, -3.0F, -0.4F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.7F, 0.0F, 0.0F, 0.0F, -0.4363F));
        ...
        ModelPartData lAntler04b = lAntler04a.addChild("lAntler04b", ModelPartBuilder.create().uv(29, 35).cuboid(-0.5F, -2.0F, -0.4F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.0F, 0.0F, -0.3142F));
        ...
        ModelPartData lAntler05b = lAntler05a.addChild("lAntler05b", ModelPartBuilder.create().uv(32, 24).cuboid(-0.5F, -2.0F, -0.4F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.0F, 0.0F, -0.5236F));
        ...
        ModelPartData lAntler06b = lAntler06a.addChild("lAntler06b", ModelPartBuilder.create().uv(32, 32).cuboid(-0.5F, -0.6F, -3.0F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.1F, 0.0F, -3.4F, 0.0F, 0.576F, 0.0F));
        ...
        ModelPartData lAntler07b = lAntler07a.addChild("lAntler07b", ModelPartBuilder.create().uv(32, 28).cuboid(-0.5F, -0.5F, -3.0F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.1F, 0.0F, -3.4F, 0.0F, 0.576F, 0.0F));
        ...
        ModelPartData rAntler03d = rAntler03c.addChild("rAntler03d", ModelPartBuilder.create().uv(25, 33).cuboid(-4.174F, -15.207F, -9.7537F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.7F, 0.0F, 0.0F, 0.0F, 0.4363F));
        ...
        ModelPartData rAntler04b = rAntler04a.addChild("rAntler04b", ModelPartBuilder.create().uv(26, 28).cuboid(-10.5008F, -13.2509F, 4.4374F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.0F, 0.0F, 0.3142F));
        ...
        ModelPartData rAntler06b = rAntler06a.addChild("rAntler06b", ModelPartBuilder.create().uv(17, 32).cuboid(0.2503F, -5.8483F, -17.896F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-0.1F, 0.0F, -3.4F, 0.0F, -0.576F, 0.0F));
        ...
        ModelPartData rAntler07b = rAntler07a.addChild("rAntler07b", ModelPartBuilder.create().uv(27, 29).cuboid(3.2962F, -13.1383F, -11.7099F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-0.1F, 0.0F, -3.4F, 0.0F, -0.576F, 0.0F));
