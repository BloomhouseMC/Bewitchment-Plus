...
public class HerneStatueModel<T extends Entity> extends EntityModel<T> {
    ...
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(BewitchmentPlus.MODID, "statue_herne"), "main");
    ...
    public static TexturedModelData create(){
        ...
        .uv(19, 50).cuboid(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 3.0F),
        ModelTransform.of(2.6F, -4.8F, -1.2F, 0.0F, -0.1047F, 0.0873F));
        ModelPartData BipedLeftArm = chest.addChild("BipedLeftArm",
        ModelPartBuilder.create()
        .uv(51, 31).cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 21.0F, 1.0F),
        ModelTransform.of(-5.5F, -6.3F, 0.0F, -0.9599F, 0.0F, 0.1396F));
        ModelPartData lArm01 = BipedLeftArm.addChild("lArm01",
        ModelPartBuilder.create()
        .uv(59, 13).mirrored(true).cuboid(-2.0F, -2.0F, -2.5F, 4.0F, 12.0F, 5.0F),
        ModelTransform.of(0.0F, 0.0F, 0.0F, 0.3491F, -0.1745F, 0.0F));
        lArm01.addChild("lArm02",
        ModelPartBuilder.create()
        .uv(60, 32).mirrored(true).cuboid(-1.5F, -1.0F, -2.0F, 3.0F, 13.0F, 4.0F),
        ModelTransform.of(0.0F, 9.5F, 0.0F, -1.4835F, 0.0F, 0.0F));
        lArm01.addChild("lMantle",
        ModelPartBuilder.create()
        .uv(69, 45).mirrored(true).cuboid(-2.5F, -2.0F, -3.0F, 5.0F, 7.0F, 6.0F),
        ModelTransform.of(-0.1F, -0.3F, 0.0F, 0.0F, 0.0F, 0.0F));
        ModelPartData BipedRightArm = chest.addChild("BipedRightArm",
        ModelPartBuilder.create()
        .uv(51, 31).cuboid(-0.5F, -2.0F, -0.5F, 1.0F, 21.0F, 1.0F),
        ModelTransform.of(5.5F, -6.3F, 0.0F, -0.1396F, 0.0F, -0.1396F));
        ModelPartData rArm01 = BipedRightArm.addChild("rArm01",
        ModelPartBuilder.create()
        .uv(59, 13).cuboid(-2.0F, -2.0F, -2.5F, 4.0F, 12.0F, 5.0F),
        ModelTransform.of(0.0F, 0.0F, 0.0F, -0.0349F, 0.0F, 0.0F));
        rArm01.addChild("rArm02",
        ModelPartBuilder.create()
        .uv(60, 32).cuboid(-1.5F, -1.0F, -2.0F, 3.0F, 13.0F, 4.0F),
        ModelTransform.of(0.0F, 9.5F, 0.0F, -0.5236F, 0.0F, 0.0F));
        rArm01.addChild("rMantle",
        ModelPartBuilder.create()
        .uv(69, 45).cuboid(-2.5F, -2.0F, -3.0F, 5.0F, 7.0F, 6.0F),
        ModelTransform.of(-0.1F, -0.3F, 0.0F, 0.0F, 0.0F, 0.0F));
        ...
        ModelPartData leftLeg00 = stomach.addChild("leftLeg00",
        ModelPartBuilder.create()
        .uv(0, 16).mirrored(true).cuboid(-2.5F, -0.7F, -3.0F, 5.0F, 12.0F, 6.0F),
        ModelTransform.of(-2.5F, 3.0F, 0.1F, -0.7156F, 0.4189F, 0.1047F));
        ModelPartData leftLeg01 = leftLeg00.addChild("leftLeg01",
        ModelPartBuilder.create()
        .uv(0, 34).mirrored(true).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F),
        ModelTransform.of(0.0F, 9.5F, -0.7F, 1.309F, 0.0F, -0.0873F));
        ModelPartData leftLeg02 = leftLeg01.addChild("leftLeg02",
        ModelPartBuilder.create()
        .uv(0, 47).mirrored(true).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F),
        ModelTransform.of(0.0F, 6.5F, 1.3F, -0.9599F, 0.0F, 0.0F));
        ModelPartData lHoofClaw01a = leftLeg02.addChild("lHoofClaw01a",
        ModelPartBuilder.create()
        .uv(9, 60).mirrored(true).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F),
        ModelTransform.of(-0.7F, 8.4F, -1.4F, 0.4189F, 0.1047F, 0.0F));
        lHoofClaw01a.addChild("lHoofClaw01b",
        ModelPartBuilder.create()
        .uv(0, 59).mirrored(true).cuboid(-0.51F, -1.1F, -1.2F, 1.0F, 1.0F, 3.0F),
        ModelTransform.of(0.0F, 0.0F, -0.8F, 0.3491F, 0.0F, 0.0F));
        ModelPartData lHoofClaw02a = leftLeg02.addChild("lHoofClaw02a",
        ModelPartBuilder.create()
        .uv(9, 60).mirrored(true).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F),
        ModelTransform.of(0.6F, 8.4F, -1.4F, 0.4189F, -0.0524F, 0.0F));
        ...
        ModelPartBuilder.create()
        .uv(0, 16).cuboid(-2.5F, -0.7F, -3.0F, 5.0F, 12.0F, 6.0F),
        ModelTransform.of(2.5F, 3.0F, 0.1F, 0.0873F, 0.0F, -0.1047F));
        ModelPartData rightLeg01 = rightLeg00.addChild("rightLeg01",
        ModelPartBuilder.create()
        .uv(0, 34).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F),
        ModelTransform.of(0.0F, 9.5F, -0.7F, 1.1694F, 0.0F, -0.1047F));
        ModelPartData rightLeg02 = rightLeg01.addChild("rightLeg02",
        ModelPartBuilder.create()
        .uv(0, 47).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F),
        ModelTransform.of(0.0F, 6.5F, 0.8F, -1.309F, 0.0F, 0.1745F));
        ModelPartData rHoofClaw01a = rightLeg02.addChild("rHoofClaw01a",
        ModelPartBuilder.create()
        ...
        ModelTransform.of(0.0F, 0.0F, -0.8F, 0.3491F, 0.0F, 0.0F));
        ModelPartData rHoofClaw02a = rightLeg02.addChild("rHoofClaw02a",
        ModelPartBuilder.create()
        .uv(9, 60).cuboid(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F),
        ...
        .uv(111, 48).cuboid(-0.5F, -0.7F, -3.5F, 1.0F, 9.0F, 7.0F),
        ModelTransform.of(4.7F, 2.1F, -0.1F, -0.1745F, 0.0F, -0.1745F));
        ModelPartData neck00 = chest.addChild("neck00",
        ModelPartBuilder.create()
        .uv(51, 0).cuboid(-3.5F, -3.7F, -3.0F, 7.0F, 5.0F, 6.0F),
        ModelTransform.of(0.0F, -8.1F, -0.1F, 0.3491F, -0.2269F, 0.0F));
        ModelPartData neck01 = neck00.addChild("neck01",
        ModelPartBuilder.create()
        .uv(28, 0).cuboid(-3.11F, -3.0F, -2.5F, 6.0F, 3.0F, 5.0F),
        ModelTransform.of(0.0F, -3.1F, 0.1F, -0.2618F, 0.0F, 0.0F));
        ModelPartData head = neck01.addChild("head",
        ModelPartBuilder.create()
        .cuboid(-3.0F, -4.8F, -3.6F, 6.0F, 5.0F, 6.0F),
        ModelTransform.of(0.0F, -2.8F, 0.2F, -0.0524F, -0.2618F, 0.0F));
        head.addChild("snout",
        ModelPartBuilder.create()
        ...
        neck01.addChild("neckFur00",
        ModelPartBuilder.create()
        .uv(78, 17).cuboid(-2.5F, 0.0F, -1.3F, 5.0F, 5.0F, 2.0F),
        ModelTransform.of(0.0F, -2.4F, -1.4F, -0.7679F, 0.0F, 0.0F));
        neck00.addChild("neckFur01",
        ModelPartBuilder.create()
        .uv(93, 16).cuboid(-3.0F, 0.0F, -1.3F, 6.0F, 6.0F, 2.0F),
        ModelTransform.of(0.0F, -4.6F, -1.3F, -0.7854F, 0.0F, 0.0F));
        neck00.addChild("neckFur02",
        ModelPartBuilder.create()
        .uv(110, 16).cuboid(-3.0F, 0.0F, -1.3F, 6.0F, 8.0F, 2.0F),
        ModelTransform.of(0.0F, -2.5F, -1.8F, -0.6981F, 0.0F, 0.0F));
        chest.addChild("mMantle",
        ModelPartBuilder.create()
        .uv(75, 26).cuboid(-6.0F, 0.0F, -4.5F, 12.0F, 10.0F, 9.0F),
        ModelTransform.of(0.0F, -8.8F, -0.5F, 0.0F, 0.0F, 0.0F));
        ModelPartData spear01a = root.addChild("spear01a",
        ModelPartBuilder.create()
        .uv(0, 65).cuboid(-0.2F, -8.0F, -0.5F, 1.0F, 32.0F, 1.0F),
        ModelTransform.of(-4.3F, -15.0F, -14.5F, 0.2618F, 0.0F, -0.6981F));
        spear01a.addChild("spear01b",
        ModelPartBuilder.create()
        .uv(0, 65).cuboid(-0.8F, -8.0F, -0.5F, 1.0F, 32.0F, 1.0F),
        ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F));
        ModelPartData spear02 = spear01a.addChild("spear02",
        ModelPartBuilder.create()
        .uv(0, 65).cuboid(-0.5F, 0.0F, -0.5F, 1.0F, 8.0F, 1.0F),
        ModelTransform.of(0.0F, 23.8F, 0.0F, 0.0F, 0.0F, 0.0F));
        spear02.addChild("spearTip03a",
        ModelPartBuilder.create()
        .uv(6, 71).cuboid(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F),
        ModelTransform.of(0.0F, 10.3F, 0.0F, 0.0F, 0.0F, 0.7854F));
        spear02.addChild("spearTip02",
        ModelPartBuilder.create()
        .uv(7, 65).cuboid(-1.0F, -0.7F, -0.5F, 2.0F, 2.0F, 1.0F),
        ModelTransform.of(0.0F, 8.5F, 0.0F, 0.0F, 0.0F, 0.0F));
