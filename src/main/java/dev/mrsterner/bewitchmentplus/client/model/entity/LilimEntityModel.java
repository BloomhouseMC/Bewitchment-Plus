...
public static final EntityModelLayer LILIM_MODEL_LAYER = new EntityModelLayer(new Identifier(BewitchmentPlus.MODID, "lilim"), "main");
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartBuilder.create().uv(32, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F).add(0.5F)),
		...
		ModelPartData boobHair = boobs.addChild("boobHair", ModelPartBuilder.create().uv(0, 52).cuboid(-3.5F, 0.15F, -0.13F, 7.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 3.8F, -2.0F, 0.6981F, 0.0F, 0.0F));
		...
		ModelPartData frontLoincloth = stomach.addChild("frontLoincloth", ModelPartBuilder.create().uv(85, 0).cuboid(-4.5F, 0.0F, -0.6F, 9.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 6.3F, -1.6F, -0.2182F, 0.0F, 0.0F));
		...
		ModelPartData backLoinclothLower = backLoinclothTop.addChild("backLoinclothLower", ModelPartBuilder.create().uv(86, 20).cuboid(-4.0F, 0.0F, -0.5F, 8.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 1.5F, 0.1F, -0.3142F, 0.0F, 0.0F));

		ModelPartData lLoinCloth = stomach.addChild("lLoinCloth", ModelPartBuilder.create().uv(108, 10).cuboid(0.0F, 0.0F, -2.5F, 2.0F, 10.0F, 5.0F, new Dilation(0.0F)), ModelTransform.of(2.2F, 6.5F, 0.3F, -0.0698F, 0.0F, -0.1396F));

		ModelPartData rLoinCloth = stomach.addChild("rLoinCloth", ModelPartBuilder.create().uv(108, 10).mirrored().cuboid(-2.0F, 0.0F, -2.5F, 2.0F, 10.0F, 5.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-2.2F, 6.5F, 0.3F, -0.0698F, 0.0F, 0.1396F));
		...
		ModelPartData left_arm = root.addChild("left_arm", ModelPartBuilder.create().uv(44, 14).cuboid(-1.0F, -2.0F, -2.0F, 3.0F, 14.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(5.0F, -5.7F, 0.0F, 0.0F, 0.0F, -0.1F));

		ModelPartData right_arm = root.addChild("right_arm", ModelPartBuilder.create().uv(44, 14).mirrored().cuboid(-2.0F, -2.0F, -2.0F, 3.0F, 14.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-5.0F, -5.7F, 0.0F, 0.0F, 0.0F, 0.1F));
		...
		ModelPartData lHair = head.addChild("lHair", ModelPartBuilder.create().uv(54, 0).mirrored().cuboid(0.0F, 0.0F, -1.5F, 2.0F, 10.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(2.4F, -6.3F, 1.1F, 0.3491F, 0.0F, -0.3142F));

		ModelPartData rHair = head.addChild("rHair", ModelPartBuilder.create().uv(54, 0).mirrored().cuboid(-2.0F, 0.0F, -1.5F, 2.0F, 10.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-2.4F, -6.3F, 1.1F, 0.3491F, 0.0F, 0.3142F));
		...
		ModelPartData lHorn05 = lHorn04a.addChild("lHorn05", ModelPartBuilder.create().uv(0, 0).mirrored().cuboid(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -2.8F, 0.0F, 0.0524F, 0.0F, 0.2269F));
		...
		ModelPartData rHorn05 = rHorn04a.addChild("rHorn05", ModelPartBuilder.create().uv(0, 0).mirrored().cuboid(-0.5F, -3.0F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -2.8F, 0.0F, 0.0524F, 0.0F, -0.2269F));
		...
		ModelPartData Base_r1 = HAIR.addChild("Base_r1", ModelPartBuilder.create().uv(104, 25).cuboid(-5.0F, -2.0F, -1.25F, 6.0F, 10.0F, 6.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 3.0F, -4.25F, 0.6109F, 0.7854F, 0.4363F));
