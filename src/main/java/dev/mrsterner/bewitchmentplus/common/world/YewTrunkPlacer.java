...
public class YewTrunkPlacer extends TrunkPlacer {
    public static final Codec<YewTrunkPlacer> CODEC = RecordCodecBuilder.create(
            instance -> fillTrunkPlacerFields(instance).apply(instance, YewTrunkPlacer::new)
    );

    public YewTrunkPlacer(int i, int j, int k) {
        super(i, j, k);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return BWPPlacerTypes.YEW_TRUNK_PLACER;
    }
