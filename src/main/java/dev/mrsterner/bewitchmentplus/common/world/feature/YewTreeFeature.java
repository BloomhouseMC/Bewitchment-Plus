...
public class YewTreeFeature extends Feature<ProbabilityConfig> {
    ...
    public boolean generate(FeatureContext<ProbabilityConfig> context) {
        ...
        Identifier nbtIdentifier = new Identifier(BewitchmentPlus.MODID, "yew_tree_0");
        ...
        }else if (WorldgenHelper.treeNearby(context.getWorld(), context.getOrigin(), structureOptional.get().getSize().getY(), 0)) {
