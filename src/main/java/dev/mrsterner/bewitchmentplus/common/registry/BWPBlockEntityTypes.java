...
public class BWPBlockEntityTypes {
    ...
    public static final BlockEntityType<YewLogBlockEntity> YEW_LOG_BLOCK_ENTITY = register("yew_log", FabricBlockEntityTypeBuilder.create(YewLogBlockEntity::new, YEW_LOG, YEW_WOOD).build(null));
