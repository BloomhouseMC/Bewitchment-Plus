...
public class BWPParticleTypes {
    ...
    public static void init() {
        LIFE_DRAIN = Registry.register(Registries.PARTICLE_TYPE, "bwplus:life_drain", FabricParticleTypes.simple(true));
        MILK_DRAIN = Registry.register(Registries.PARTICLE_TYPE, "bwplus:milk_drain", FabricParticleTypes.simple(true));
        WITHER_DRAIN = Registry.register(Registries.PARTICLE_TYPE, "bwplus:wither_drain", FabricParticleTypes.simple(true));
        ...
        LIFE_DRAIN_TRAIL = Registry.register(Registries.PARTICLE_TYPE, "bwplus:life_drain_trail", new ParticleType<LifeDrainParticleEffect>(true, LifeDrainParticleEffect.PARAMETERS_FACTORY) {
            @Override
