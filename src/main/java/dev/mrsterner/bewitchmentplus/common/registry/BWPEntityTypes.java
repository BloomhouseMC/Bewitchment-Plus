...
public class BWPEntityTypes {
	...
	public static final EntityType<UnicornEntity> UNICORN = register("unicorn", UnicornEntity.createAttributes(), FabricEntityTypeBuilder.createMob().spawnGroup(SpawnGroup.CREATURE).entityFactory(UnicornEntity::new).dimensions(EntityDimensions.changing(1f, 2f)).build());
