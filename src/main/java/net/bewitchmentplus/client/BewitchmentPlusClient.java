...
import net.bewitchmentplus.client.renderer.entity.living.CleaverEntityRenderer;
...
public class BewitchmentPlusClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		EntityRendererRegistry.INSTANCE.register(BWPEntityTypes.CLEAVER, (entityRenderDispatcher, context) -> new CleaverEntityRenderer(entityRenderDispatcher));
	}
}