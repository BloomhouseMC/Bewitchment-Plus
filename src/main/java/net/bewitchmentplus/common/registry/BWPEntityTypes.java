...
public class BWPEntityTypes {
	...
	public static final EntityType<CleaverEntity> CLEAVER = create("cleaver", CleaverEntity.createAttributes(), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, CleaverEntity::new).dimensions(EntityDimensions.changing(0.75f, 3f)).build());
